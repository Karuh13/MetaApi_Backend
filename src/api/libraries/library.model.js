...
const librarySchema = new Schema (
    {
        ...
        version:{type: String, trim: true, default: "not specified"},
        command: [{type: mongoose.Schema.Types.ObjectId, ref:"commands"}],
        img: {type: String, defaul:"https://pbs.twimg.com/profile_images/1473729155506319360/TjcpeV6k_400x400.jpg", trim:true},
    },
    {
        timestamps: true,
    }
